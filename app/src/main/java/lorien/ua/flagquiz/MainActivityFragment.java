...
public class MainActivityFragment extends Fragment {
    ...
    private OnClickListener guessButtonListener = new OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if (guess.equals(answer)) {
                ...
                int correctAnswerTextColor = getResources().getColor(R.color.correct_answer);
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    correctAnswerTextColor = getResources().getColor(R.color.correct_answer, getContext().getTheme());
                }

                answerTextView.setText(answer + "!");
                answerTextView.setTextColor(correctAnswerTextColor);

                disableButtons();

                if (correctAnswers == FLAGS_IN_QUIZ) {
                    DialogFragment quizResults = MainDialogFragment
                ...
                int incorrectAnswerTextColor = getResources().getColor(R.color.correct_answer);
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    incorrectAnswerTextColor = getResources().getColor(R.color.correct_answer, getContext().getTheme());
                ...
                answerTextView.setTextColor(incorrectAnswerTextColor);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        answerTextView = (TextView) view.findViewById(R.id.aswerTextView);
    ...
    public static class MainDialogFragment extends DialogFragment {
        ...
        public static MainDialogFragment newInstance(String message) {
        ...
        public Dialog onCreateDialog(Bundle bundle) {
            ...
            builder.setPositiveButton(R.string.reset_quiz, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    MainActivityFragment fragment = (MainActivityFragment) getFragmentManager()
